            ...
            <div class="timeliner_element" style="float: none;">\
                ...
                <div class="content">\
                    <div class="form-group">\
                        <label class="col-sm-2 control-label" for="form-field-2"> 日期 </label>\
                        <div class="col-sm-9">\
                            <input type="text" placeholder="选择日期" name="date" class="form-control datepicker" required="required" data-date-format="yyyy mm dd">\
                        </div>\
                    </div>\
                    <div class="form-group">\
                        <label class="col-sm-2 control-label" for="form-field-1"> 标题 </label>\
                        <div class="col-sm-9">\
                            <input type="text" placeholder="新标题" name="title" class="form-control" required="required">\
                        </div>\
                    </div>\
                    <div class="form-group">\
                        <label class="col-sm-2 control-label" for="form-field-12"> 内容 </label>\
                        <div class="col-sm-9">\
                            <textarea placeholder="请输入内容" rows="10" name="content" class="form-control" required="required"></textarea>\
                        </div>\
                    </div>\
                    <div class="form-group">\
                        <label class="col-sm-2 control-label" for="form-field-12"> 背景色 </label>\
                        <div class="col-sm-9">\
                            <select class="form-control" name="class" >\
                                <option value="" seleted="selected">无</option>\
                                <option value="bricky">红色</option>\
                                <option value="green">绿色</option>\
                                <option value="purple">黄色</option>\
                                <option value="teal">淡蓝色</option>\
                            </select>\
                        </div>\
                    </div>\
                </div>\
                <div class="readmore">\
                    <button class="btn" type="reset"><i class="fa fa-times"></i> 取消</button>\
